        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipTakenDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EnquiryHistories", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_EnquiryHistories_Enquiries_EnquiryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembersMemberships", x => x.MembersMembershipId);
                    table.ForeignKey(
                        name: "FK_MembersMemberships_Enquiries_EnquiryId",
                        column: x => x.EnquiryId,
                        principalTable: "Enquiries",
                        principalColumn: "EnquiryId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MembersMemberships_MembershipPlans_MembershipPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EnquiryHistories_EnquiryId",
                table: "EnquiryHistories",
                column: "EnquiryId");

            migrationBuilder.CreateIndex(
                name: "IX_MembersMemberships_EnquiryId",
                table: "MembersMemberships",
                column: "EnquiryId");

            migrationBuilder.CreateIndex(
                name: "IX_MembersMemberships_MembershipPlanId",
                table: "MembersMemberships",
